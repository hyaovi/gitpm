function Strings( config ) {
	...
	var values = {
		ru: {
			...
			'menubar/import/exporttowebar': 'Экспорт в WebAR',

			'modal/text/step/1': 'ШАГ 1.',
			'modal/text/main/1': 'Выберите в меню редактора "Файл" → "Опубликовать", чтобы скачать .zip архив своего проекта.',
			'modal/text/step/2': 'ШАГ 2.',
			'modal/text/main/2': 'Откройте .zip архив, найдите и разархивируйте файл app.json.',
			'modal/text/step/3': 'ШАГ 3.',
			'modal/text/main/3': 'Откройте редактор проектов MyWebAR и добавьте файл app.json как Json MAE object.',
			'modal/text/url': 'По всем вопросам пишите на',
			'modal/text/head': 'Как экспортировать сцену MAE в WebAR:',
			'modal/text/button/show': 'Посмотреть видеоурок',
			'modal/text/button/back': 'Назад',
			'modal/text/button/close': 'закрыть',
			...
			'menubar/add/directionallight': 'Направленный свет',
			...
			'menubar/import': 'Импортировать',
			'menubar/import/local': 'C вашего компьютера',
			'menubar/import/devar': 'Из библиотеки Devar',
			...
			'sidebar/animations/timescale': 'Время',
			'sidebar/animations/play': 'Запустить',
		...
		en: {
			'menubar/mywebar/logo': 'Mywebar',
			'menubar/import/exporttowebar': 'Export to WebAR',
			...
			'menubar/import/local': 'Your PC',
			'menubar/import/devar': 'Library Devar',
			...
			'modal/text/step/1': 'STEP 1.',
			'modal/text/main/1': 'Click ‘File’ → ‘Publish’ in the toolbar to download a .zip archive with your project data.',
			'modal/text/step/2': 'STEP 2.',
			'modal/text/main/2': 'Open the .zip file and unarchive the app.json file from it.',
			'modal/text/step/3': 'STEP 3.',
			'modal/text/main/3': 'Open a MyWebAR project editor and upload your app.json file as a Json MAE object.',
			'modal/text/url': 'For support, email us at',
			'modal/text/head': 'How to export your MAE scene to WebAR:',
			'modal/text/button/show': 'Watch Video Tutorial',
			'modal/text/button/back': 'Back',
			'modal/text/button/close': 'close',
